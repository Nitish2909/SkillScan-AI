      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mt-8 border-t border-gray-800 pt-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex items-center justify-center gap-2 bg-pink-600 hover:bg-pink-700 px-6 py-3 rounded-xl font-semibold disabled:opacity-60"
          >
            <Star size={18} />
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#020617] to-[#020617] text-white flex flex-col items-center p-10">
//       {/* Heading */}
...
//         onSubmit={handleSubmit}
//         encType="multipart/form-data"
//         className="w-full max-w-6xl bg-[#0b1220] border border-gray-800 rounded-2xl p-8 shadow-lg"
//       >
...
//               onChange={(e) => setJobDescription(e.target.value)}
//               placeholder="Paste the full job description here..."
//               className="w-full h-72 bg-[#020617] border border-gray-700 rounded-xl p-4 text-gray-300 focus:outline-none focus:border-pink-500"
//               maxLength={5000}
//             />
...
//               <label className="border border-dashed border-gray-700 rounded-xl p-8 flex flex-col items-center justify-center text-gray-400 cursor-pointer hover:border-pink-500">
//                 <UploadCloud size={40} />
//                 <p className="mt-3">Click to upload or drag & drop</p>
...
//         {/* Footer */}
//         <div className="flex justify-between items-center mt-8 border-t border-gray-800 pt-6">
//           <p className="text-gray-500 text-sm">
//             AI-Powered Strategy Generation • Approx 30s
//           </p>
...
//             type="submit"
//             disabled={loading}
//             className="flex items-center gap-2 bg-pink-600 hover:bg-pink-700 px-6 py-3 rounded-xl font-semibold"
//           >
//             <Star size={18} />
...
//       {/* Bottom Links */}
//       <div className="flex gap-6 text-gray-500 text-sm mt-6">
//         <p className="cursor-pointer hover:text-white">Privacy Policy</p>
//         <p className="cursor-pointer hover:text-white">Terms of Service</p>
//         <p className="cursor-pointer hover:text-white">Help Center</p>
//       </div>
