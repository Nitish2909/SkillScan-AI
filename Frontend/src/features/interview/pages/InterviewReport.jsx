    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] to-[#020617] text-white lg:grid lg:grid-cols-[250px_1fr_300px]">
      ...
      <aside className="border-b lg:border-b-0 lg:border-r border-gray-800 p-4 md:p-6">
        ...
        <button
          ...
          className="mt-6 w-full bg-pink-600 hover:bg-pink-700 px-4 py-3 rounded-lg font-medium"
        >
          Download Resume
        </button>
      </aside>
      ...
      <aside className="border-t lg:border-t-0 lg:border-l border-gray-800 p-6">
        ...
        <div className="mb-10 text-center">
          ...
          <div
            className={`w-28 h-28 mx-auto rounded-full border-[8px] flex items-center justify-center text-2xl font-bold ${scoreColor}`}
          >
            {report.matchScore}%
          </div>
        </div>
...
//       <button
//         onClick={() => setOpen(!open)}
//         className="w-full flex justify-between items-center p-5 text-left hover:bg-gray-900 transition"
//       >
//         <div className="flex gap-4 items-center">
//           <span className="text-pink-500 font-semibold">Q{index + 1}</span>
...
//         }`}
//       >
//         <div className="overflow-hidden px-5 pb-5 text-gray-400 text-sm space-y-4">
//           <div>
//             <span className="text-blue-400 text-xs font-semibold">
//               Intention
//             </span>
...
// const RoadMapDay = ({ day }) => {
//   return (
//     <div className="bg-[#0b1220] border border-gray-800 rounded-xl p-5">
//       <div className="flex items-center gap-4 mb-3">
//         <span className="bg-pink-500/20 text-pink-400 px-3 py-1 rounded-full text-xs">
//           Day {day.day}
//         </span>
...
//       <aside className="w-64 border-r border-gray-800 p-6 flex flex-col justify-between sticky top-0 h-screen">
//         <div>
//           <p className="text-gray-400 text-sm mb-6 uppercase">Sections</p>
...
//         <button
//           onClick={() => getResumePdf(interviewId)}
//           className="mt-10 bg-pink-600 hover:bg-pink-700 px-4 py-3 rounded-lg font-medium"
//         >
//           Download Resume
//         </button>
//       </aside>
...
//       <aside className="w-80 border-l border-gray-800 p-6 sticky top-0 h-screen">
...
//           <div
//             className={`w-32 h-32 mx-auto rounded-full border-[8px] flex items-center justify-center text-3xl font-bold ${scoreColor}`}
//           >
//             {report.matchScore}%
//           </div>
